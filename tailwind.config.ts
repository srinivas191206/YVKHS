  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "healing-mint": "hsl(var(--healing-mint))",
        "healing-mint-soft": "hsl(var(--healing-mint-soft))",
        "sky-blue": "hsl(var(--sky-blue))",
        "sky-blue-soft": "hsl(var(--sky-blue-soft))",
        "warm-coral": "hsl(var(--warm-coral))",
        "warm-coral-soft": "hsl(var(--warm-coral-soft))",
